...
const everything = function(element) {
  ...
  playIconContainer.addEventListener('click', () => {
    if(playState === 'paused') {
      audio.play();
      playIconContainer.style.background = "url(files/assets/layout/pause.svg"
      /*playAnimation.playSegments([14, 27], true);*/
      requestAnimationFrame(whilePlaying);
      playState = 'playing';
    } else {
      audio.pause();
      playIconContainer.style.background = "url(files/assets/layout/play.svg"
  ...
  muteIconContainer.addEventListener('click', () => {
    if(muteState === 'unmute') {
      muteIconContainer.style.background = "url(files/assets/layout/muted.svg"
      /*muteAnimation.playSegments([0, 15], true);*/
      audio.muted = true;
      muteState = 'mute';
    } else {
      muteIconContainer.style.background = "url(files/assets/layout/sound.svg"
